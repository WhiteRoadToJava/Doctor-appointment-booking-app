...
const Navbar = () => {
  ...
  // const [showMenu, setShowMenu] = useState(false); // This is unused for now
      ...
      <div className="flex items-center gap-4">
        {
          ...
          :
          <button onClick={() => navigate('/login')} className="bg-primary text-black py-3 px-8 rounded-full font-light hidden md:block">Create Account</button>
        }
